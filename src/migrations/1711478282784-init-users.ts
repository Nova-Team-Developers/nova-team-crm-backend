...
export class InitUsers1711478282784 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "mentor" ADD CONSTRAINT "FK_191030b57cc126fddb76ce94707" FOREIGN KEY ("managerId") REFERENCES "manager"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
